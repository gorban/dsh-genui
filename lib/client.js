window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$1 = "@gorban/dsh-genui/src/client/genui-assistant.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$1) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@gorban/dsh-genui";
		...
		*/
		...
		const tagId = "@gorban/dsh-genui/src/client/prompt-toggle-button.module.css";
